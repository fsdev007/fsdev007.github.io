...
(function() {
    ...
    function mediaEventHandler(pEvent) {
        $.get("http://dashboard.findabilitysciences.com/seventen28/api/v1/ajaxtrackvideoplayed.html?id=" + _videoId+"&source=facebook");
        $.get("http://dashboard.findabilitysciences.com/seventen28dev/api/v1/ajaxtrackvideoplayed.html?id=" + _videoId+"&source=facebook");
        $.get("http://dev.seventen28.com/api/v1/ajaxtrackvideoplayed.html?id=" + _videoId+"&source=facebook");
    }
